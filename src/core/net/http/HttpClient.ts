class HttpClient {
	 public responseType: string;
        ...
        public static serverUrl: string = "http://192.168.1.38:7071/api/report";
        ...
        public send(method: string, callback: Function, target: any, data: any, url :string = HttpClient.serverUrl) {
            ...
            var server_url = url? url : HttpClient.serverUrl;
        ...
        public static get(callback: Function, target: any, data: any, responseType: string = "JSON", url:string = HttpClient.serverUrl): void {
        ...
        public static post(callback: Function, target: any, data: any, responseType: string = "JSON", url:string = HttpClient.serverUrl): void {
            var client = new HttpClient();
